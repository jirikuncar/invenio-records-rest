...
def get_default_endpoint_for(pid_type, records_rest_endpoints=None):
    """Get default endpoint for the given pid_type."""
    if records_rest_endpoints is None:
        endpoint_prefixes = current_record_rest.default_endpoint_prefixes
    else:
        endpoint_prefixes = build_default_endpoint_prefixes(
            records_rest_endpoints
        )

    return endpoint_prefixes[pid_type]
